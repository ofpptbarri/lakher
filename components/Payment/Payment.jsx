...
export default function PaimentM(){
    const {titre} = useParams();
    return(
        <>
        <Navbar />
        {data.filter(item =>item.titre === titre).map((item)=>(
            ...
            <div className="achatdv">
                ...
                <div className="achatinfo">
                   ...
                   <button className="btnachat"><Link  className="ACHETERM" to={`/pdfsport/${item.titre}`}>Acheter maintenant</Link></button>
